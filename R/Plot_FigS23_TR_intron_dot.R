...
p3<-make_pie(data2_a)
p4<-make_pie(data2_b)
p5<-make_bar(data3_a,20000)+ theme(axis.text.x = element_blank(), axis.title.x = element_blank()) 
...
outfile=paste(plotdir,"FigS23_Introns_and_TRs_ABCompartments.png", sep="")
