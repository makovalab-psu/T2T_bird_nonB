...
outfile2=paste(plotdir,"FigS17_NonB_enrichment_Satellites_log2_facet.png", sep="")
...
outfile3=paste(plotdir,"FigS15_NonB_enrichment_vs_TandemRepeatUnit.png", sep="")
ggsave(outfile3,plot = p3,scale = 1,dpi = 300,limitsize = TRUE,width=7,height=7)
