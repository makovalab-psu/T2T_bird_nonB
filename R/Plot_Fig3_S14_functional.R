...
# SUPPLEMENTARY FIG14, ONE SIDE PER SPECIES 
for (nm in names(g4_plots)) {
  if(nm!="zebra_finch") {
    pa<-plots[[nm]] 
    pb<-g4_plots[[nm]] 
    ...
    ggsave(
      filename = paste0("plots/FigS14_", nm, "_Functional_combined_nolncrna.png"),
      plot = p2_final,
