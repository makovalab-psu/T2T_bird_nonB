...
final=(pA/pBC)+plot_layout(heights=c(3,3.5))
final
outfile=paste(plotdir,"Fig4_repeats.svg", sep="")
ggsave(outfile,plot = final,scale = 1,dpi = 600,limitsize = TRUE,width=11,height=11)
outfile=paste(plotdir,"Fig4_repeats.png", sep="")
ggsave(outfile,plot = final,scale = 1,dpi = 300,limitsize = TRUE,width=11,height=11)
