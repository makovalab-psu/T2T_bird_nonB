...
# Input files 
compfile="compart/microdot_summary.10kb.txt"
hifiABfile="densities/bTaeGut7v0.4_MT_rDNA.hifi.nonB_and_seqCov.dotComp.tsv"   
ontABfile="densities/bTaeGut7v0.4_MT_rDNA.ont.nonB_and_seqCov.dotComp.tsv"   
...
DATAC$NonB <- factor(DATAC$NonB, levels=c("ALL","APR", "DR", "STR", "IR", "MR","TRI", "G4", "Z"))
...
outfile=paste(plotdir,"Fig5_nonB_in_ABdots.png", sep="")
#outfile=paste(plotdir,"Fig5_nonB_in_ABdots.svg", sep="")
